...
public class WeaponDataSO : ScriptableObject
{
    ...
    [field: SerializeField] [field: Range (0, 1000)] public int AmmoCapacity { get; set; } = 100;
    [field: SerializeField] [field: Range (0.01f, 2f)]public float WeaponDelay { get; set; } = 0.1f;
    ...
    [SerializeField] [Range (1, 10)]private int bulletCount = 0;
